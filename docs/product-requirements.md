...
*   **NFR-07 - Diseño de Layout:** El sistema debe mantener una estructura de layout coherente y adaptable, asegurando que los elementos principales (Topbar, Sidebar, Main Content) se presenten de manera clara y accesible en diferentes tamaños de pantalla. Respetar el diseño indicado en la sección "Diseño de Layout".

## Diseño de Layout (NFR-07)
